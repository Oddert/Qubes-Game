...
function drawOnionGraph() {
    ...
    const radius = min(canvasWidth, canvasHeight) * 0.5 * 0.75
    ...
    const colours = [
        ...
        {
            default: '#5fc095', hover: '#79DAAF', antihover: '#bec3c7', active: '#bec3c7', inactive: '#ecf0f1',
        }, // 92F3C8
        {
            default: '#3aaad4', hover: '#54C4EE', antihover: '#bec3c7', active: '#bec3c7', inactive: '#ecf0f1',
        },
        {
            default: '#b892c0', hover: '#D2ACDA', antihover: '#bec3c7', active: '#bec3c7', inactive: '#ecf0f1',
        }, // EBC5F3
        {
    ...
    function select(target) {
        ...
        const canvasSelectOffsetX = canvasWidth / 4
        const canvasSelectOffsetY = descDOM.scrollHeight > canvasHeight / 2
